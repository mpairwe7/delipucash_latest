...
export const mockSurveys = [
  // Running surveys — startDate in the past, endDate 30 days from now
  {
    id: "survey_001",
  ...
  // Upcoming / Scheduled surveys — startDate in the future
  {
    id: "survey_007",
  ...
  },
  {
    ...
    endDate: getFutureDate(42),
    maxResponses: 350,
    rewardAmount: 2000,
  },
  // Completed surveys — both dates in the past
  {
    id: "survey_011",
...
export const mockRewardQuestions = [
  ...
  // ── Additional regular reward questions for "Answer Questions & Earn!" ──
  {
    id: "rq_012",
  ...
  },
  {
    ...
    options: { a: "Won", b: "Yuan", c: "Yen", d: "Rupee" },
    correctAnswer: "c",
    rewardAmount: 500,
    expiryTime: getFutureDate(45),
    isActive: true,
  ...
  },
  {
    ...
    options: { a: "Swift", b: "Python", c: "Kotlin", d: "Ruby" },
    correctAnswer: "c",
    rewardAmount: 1000,
    expiryTime: getFutureDate(60),
    isActive: true,
  ...
  },
  {
    ...
    options: { a: "HyperText Transfer Protocol", b: "High Transfer Text Protocol", c: "HyperText Transmission Process", d: "High Text Transfer Protocol" },
    correctAnswer: "a",
    rewardAmount: 1000,
    expiryTime: getFutureDate(60),
    isActive: true,
  ...
  {
    id: "rq_022",
    text: "What is the national language of Uganda?",
    options: { a: "Swahili", b: "English", c: "Luganda", d: "French" },
    correctAnswer: "b",
    rewardAmount: 500,
    expiryTime: getFutureDate(30),
    isActive: true,
  ...
  {
    id: "rq_023",
    text: "How many megabytes are in one gigabyte?",
