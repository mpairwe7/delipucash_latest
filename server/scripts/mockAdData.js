 ...
 */
export const getAdsByPriority = (limit) => {
 ...
 */
export const getTopPerformingAds = (limit = 5) => {
  return [...MOCK_ADS]
    .filter(ad => ad.isActive)
 ...
 */
export const getFeaturedVideoAds = () => {
 ...
 * Get ads by status
 */
export const getAdsByStatus = (status) => {
 ...
 */
export const getAdsByPricingModel = (pricingModel) => {
 ...
 */
export const getAdsByCTA = (callToAction) => {
 ...
 */
export const getAdsByAgeRange = (ageRange) => {
 ...
 */
export const getAdsByTargetGender = (gender) => {
  return MOCK_ADS.filter(ad =>
    ad.isActive &&
 ...
 */
export const getAdsByLocation = (location) => {
  return MOCK_ADS.filter(ad =>
    ad.isActive &&
    ad.targetLocations &&
 ...
 */
export const getInterstitialAds = () => {
  return MOCK_ADS.filter(ad =>
 ...
 */
export const getRetargetingAds = () => {
 ...
 */
export const getTopConvertingAds = (limit = 5) => {
  return [...MOCK_ADS]
 ...
 */
export const getAdsByInterest = (interest) => {
  return MOCK_ADS.filter(ad =>
    ad.isActive &&
    ad.targetInterests &&
 ...
 */
export const getAdPerformance = (adId) => {
